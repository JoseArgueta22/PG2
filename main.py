...
# Cargar y mostrar la imagen de la tuerca en la esquina superior derecha
...
imagen_tuerca_tk = ImageTk.PhotoImage(imagen_tuerca)
...
boton_regresar = tk.Button(root, text="Regresar", font=("Comic Sans MS", 14), bg="#FF6347", fg="white", command=regresar, borderwidth=3, relief="solid")
